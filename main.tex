...
\begin{frame}[t]
	...
	\begin{figure}[h]
		\centering
		\scalebox{0.6}{
		\import{images}{Cashier-use-case.pdf_tex}
	}
	\end{figure}
...
\begin{frame}[t]
	...
	\begin{figure}[h]
		\centering
		\scalebox{0.6}{
		\import{images}{Cashier-start-trans.pdf_tex}
	}
	\end{figure}
\end{frame}
...
\begin{frame}[t]
	...
	\begin{figure}[h]
		\centering
		\scalebox{0.6}{
		\import{images}{Cashier-card-trans.pdf_tex}
	}
	\end{figure}
...
\begin{frame}[t]
	...
	\begin{figure}[h]
		\centering
		\scalebox{0.6}{
		\import{images}{edit-receipt.pdf_tex}
	}
	\end{figure}
...
\begin{frame}[t]
	...
	\begin{figure}[h]
		\centering
		\scalebox{0.6}{
		\import{images}{scan-age.pdf_tex}
	}
	\end{figure}
